...
case 39:
    ...
    this.$ = new yy.Expression.DivExpression(yyvstack[yysp - 5], yyvstack[yysp - 1]);
    break;
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 175 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
