...
symbols_: {
  ...
  "and": 35,
  "body": 23,
  "classifierContextDecl": 55,
  "context": 20,
  "contextDeclList": 53,
  "contextDeclaration": 54,
  "def": 27,
  "defExpression": 67,
  "derive": 25,
  "div": 31,
  ...
  "not": 28,
  "oclExpression": 65,
  "oclExpressionList": 66,
  "oclExpressionListOptional": 71,
  "operation": 60,
  "operationContextDecl": 57,
  "or": 36,
  "package": 18,
  "packageDecl": 52,
  "pathName": 79,
  ...
  "pre": 21,
  "preOptional": 74,
  "prePostOrBodyDecl": 59,
  "prePostOrBodyDeclList": 58,
  "primitiveLiteralExp": 78,
  "propertyContextDecl": 56,
  "real": 45,
  "simpleName": 29,
...
case 1:
    /*! Production::    start : packageDecl */
case 2:
    /*! Production::    start : oclExpression */
...
case 4:
    ...
    return new yy.Expression.PackageDeclaration('unnamed', yyvstack[yysp - 1]); console.log(yy.WURSTBROTKROKETTE);
    break;
...
case 41:
    ...
    this.$ = new yy.Expression.OperationCallExpression('<', yyvstack[yysp - 2], yyvstack[yysp]);
    break;
...
case 51:
    ...
    this.$ = functionCallExpression(yy, yyvstack[yysp], this.$);
    break;
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 173 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
