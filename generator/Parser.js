...
case 35:
    ...
    this.$ = new yy.Expression.AssignementExpression(yyvstack[yysp - 2], yyvstack[yysp]);
    break;
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 182 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
