 ...
 * @oclExpression String::replace(old : String, new : String) : String
 * @oclExample 'hello world'.replace('world', 'universe')
 */
export class ReplaceExpression extends BodyBasedExpression {
