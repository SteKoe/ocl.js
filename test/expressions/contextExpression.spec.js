...
describe('ContextExpression', () => {
    ...
    it('expect return name for named function', () => expect(expr._getClassName(function Abc() {
    })).to.eql('Abc'));
    it('expect return undefined anonymous function', () => expect(expr._getClassName(function () {
    })).be.undefined);
