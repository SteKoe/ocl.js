...
/***/ function(module, exports, __webpack_require__) {
	...
	var ImpliesExpressionPattern = '(' + OperationCallExpressionPattern + ')\\simplies\\s(' + OperationCallExpressionPattern + ')';
	    ...
	    _createClass(OclParser, [{
	        ...
	        value: function parsePartialOcl(oclExpression) {
	            ...
	            if (match = OclParser.isExpression(IteratorExpressionPattern, oclExpression)) {
	                ...
	                expr = new _impliesExpression2.default(this.parsePartialOcl(match[1]), this.parsePartialOcl(match[17]));
	        ...
	        value: function parseOclFunctionCall(oclExpression, match) {
	            var functionName = match[4].toLowerCase();

	            if (functionName === 'isempty') {
	                return new _isEmptyExpression2.default();
	            }

	            return new _impliesExpression2.default(this.parsePartialOcl(match[1]), this.parsePartialOcl(match[17]));
	        }
	    }], [{
	        key: 'trimLeft',
